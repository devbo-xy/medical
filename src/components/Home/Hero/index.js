            ...
            <div className="max-w-7xl mx-auto h-full flex flex-row items-center relative">
                <div className="flex flex-col justify-start space-y-5 z-[1]">
                    <div className="w-full">
                        <h2 className="max-w-xl text-4xl font-semibold">Solusi Kesehatan Terlengkap
                        </h2>
                ...
                <div className="w-[50rem] h-full absolute -right-[4rem] -bottom-[1rem]">
                    <Image
                        layout="fill"
                        src={Assets.HeroMed}
                        alt="Gambar Hero"
